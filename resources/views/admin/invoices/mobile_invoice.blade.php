...
<div id="content">
    <div class="invoice-box">
            ...
            <tr class="top">
                <td colspan="5">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="{{ asset('images/business_logo.png') }}" style="width:100%; max-width:300px;">
                            </td>
            ...
            <tr class="information">
                <td colspan="5">
                    <table>
                        <tr>
                            <td>
                                {{$invoice->profile['business_name']}}<br>
                                {{$invoice->profile['business_address_street']}} {{$invoice->profile['business_address_street2']}},<br>
                                {{$invoice->profile['business_address_city']}}, {{$invoice->profile['business_address_state']}} {{$invoice->profile['business_address_zipcode']}}<br>
                                {{$invoice->profile['business_email']}}<br>
                                {{$invoice->profile['business_phone_number']}}<br>
                                {{$invoice->profile['business_website']}}
                            </td>
                    ...
                    <strong><small>{{$invoice->profile['header_notes']}}</small></strong>
                </td>
            </tr>
            <tr class="heading">
                <td>
        ...
        <table style="width: 100%;">
            <tr>
                <td class="first">{{$invoice->profile['footer_notes_left']}}</td>
                <td class="second">{{$invoice->profile['footer_notes_right']}}</td>
            </tr>
        </table>
